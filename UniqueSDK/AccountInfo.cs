...
namespace UniqueSDK
{
	...
	public class AccountInfo
	{
        ...
        public AccountInfo(Substrate.NetApiExt.Generated.Model.frame_system.AccountInfo accountInfo, uint decimals, string unit)
        {
    ...
    public class AccountData
    {
        ...
        public AccountData(Substrate.NetApiExt.Generated.Model.pallet_balances.types.AccountData accountData, uint decimals, string unit)
        {
