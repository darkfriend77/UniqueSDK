...
namespace Substrate.NetApiExt.Generated.Storage
{
    ...
    public sealed class EVMStorage
    {
        ...
        public EVMStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("EVM", "CurrentLogs"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApiExt.Generated.Model.ethereum.Log>)));
        }
        ...
        ///  Should be empty between transactions
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApiExt.Generated.Model.ethereum.Log>> CurrentLogs(string blockhash, CancellationToken token)
        {
            string parameters = EVMStorage.CurrentLogsParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApiExt.Generated.Model.ethereum.Log>>(parameters, blockhash, token);
            return result;
        }
    }
