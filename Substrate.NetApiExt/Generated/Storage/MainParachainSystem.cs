...
namespace Substrate.NetApiExt.Generated.Storage
{
    ...
    public sealed class ParachainSystemStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "UnincludedSegment"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.unincluded_segment.Ancestor>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "AggregatedUnincludedSegment"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.unincluded_segment.SegmentTracker)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "ValidationData"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApiExt.Generated.Model.polkadot_primitives.v6.PersistedValidationData)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "UpgradeRestrictionSignal"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApiExt.Generated.Model.polkadot_primitives.v6.EnumUpgradeRestriction>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "UpgradeGoAhead"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApiExt.Generated.Model.polkadot_primitives.v6.EnumUpgradeGoAhead>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "RelayStateProof"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApiExt.Generated.Model.sp_trie.storage_proof.StorageProof)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "HostConfiguration"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApiExt.Generated.Model.polkadot_primitives.v6.AbridgedHostConfiguration)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "LastDmqMqcHead"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApiExt.Generated.Model.cumulus_primitives_parachain_inherent.MessageQueueChain)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "LastHrmpMqcHeads"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApiExt.Generated.Types.Base.BTreeMapT4)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "HrmpOutboundMessages"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApiExt.Generated.Model.polkadot_core_primitives.OutboundHrmpMessage>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "UpwardDeliveryFeeFactor"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "ReservedXcmpWeightOverride"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "ReservedDmpWeightOverride"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "AuthorizedUpgrade"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.CodeUpgradeAuthorization)));
        ...
        ///  in the pallet.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.unincluded_segment.Ancestor>> UnincludedSegment(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.UnincludedSegmentParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.unincluded_segment.Ancestor>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  respect to relay chain constraints.
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.unincluded_segment.SegmentTracker> AggregatedUnincludedSegment(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.AggregatedUnincludedSegmentParams();
            var result = await _client.GetStorageAsync<Substrate.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.unincluded_segment.SegmentTracker>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  in the trie.
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Model.polkadot_primitives.v6.PersistedValidationData> ValidationData(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.ValidationDataParams();
            var result = await _client.GetStorageAsync<Substrate.NetApiExt.Generated.Model.polkadot_primitives.v6.PersistedValidationData>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  set after the inherent.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApiExt.Generated.Model.polkadot_primitives.v6.EnumUpgradeRestriction>> UpgradeRestrictionSignal(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.UpgradeRestrictionSignalParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApiExt.Generated.Model.polkadot_primitives.v6.EnumUpgradeRestriction>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  set after the inherent.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApiExt.Generated.Model.polkadot_primitives.v6.EnumUpgradeGoAhead>> UpgradeGoAhead(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.UpgradeGoAheadParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApiExt.Generated.Model.polkadot_primitives.v6.EnumUpgradeGoAhead>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  This data is also absent from the genesis.
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Model.sp_trie.storage_proof.StorageProof> RelayStateProof(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.RelayStateProofParams();
            var result = await _client.GetStorageAsync<Substrate.NetApiExt.Generated.Model.sp_trie.storage_proof.StorageProof>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  This data is also absent from the genesis.
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.relay_state_snapshot.MessagingStateSnapshot> RelevantMessagingState(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.RelevantMessagingStateParams();
            var result = await _client.GetStorageAsync<Substrate.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.relay_state_snapshot.MessagingStateSnapshot>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  This data is also absent from the genesis.
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Model.polkadot_primitives.v6.AbridgedHostConfiguration> HostConfiguration(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.HostConfigurationParams();
            var result = await _client.GetStorageAsync<Substrate.NetApiExt.Generated.Model.polkadot_primitives.v6.AbridgedHostConfiguration>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  by the system inherent.
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Model.cumulus_primitives_parachain_inherent.MessageQueueChain> LastDmqMqcHead(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.LastDmqMqcHeadParams();
            var result = await _client.GetStorageAsync<Substrate.NetApiExt.Generated.Model.cumulus_primitives_parachain_inherent.MessageQueueChain>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  by the system inherent.
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Types.Base.BTreeMapT4> LastHrmpMqcHeads(string blockhash, CancellationToken token)
        {
        ...
        ///  This will be cleared in `on_initialize` of each new block.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApiExt.Generated.Model.polkadot_core_primitives.OutboundHrmpMessage>> HrmpOutboundMessages(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.HrmpOutboundMessagesParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApiExt.Generated.Model.polkadot_core_primitives.OutboundHrmpMessage>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  The factor to multiply the base delivery fee by for UMP.
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128> UpwardDeliveryFeeFactor(string blockhash, CancellationToken token)
        {
        ...
        ///  overrides the amount set in the Config trait.
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight> ReservedXcmpWeightOverride(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.ReservedXcmpWeightOverrideParams();
            var result = await _client.GetStorageAsync<Substrate.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  overrides the amount set in the Config trait.
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight> ReservedDmpWeightOverride(string blockhash, CancellationToken token)
        {
        ...
        ///  The next authorized upgrade, if there is one.
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.CodeUpgradeAuthorization> AuthorizedUpgrade(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.AuthorizedUpgradeParams();
            var result = await _client.GetStorageAsync<Substrate.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.CodeUpgradeAuthorization>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class ParachainSystemCalls
    {
        ...
        /// </summary>
        public static Method SetValidationData(Substrate.NetApiExt.Generated.Model.cumulus_primitives_parachain_inherent.ParachainInherentData data)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AuthorizeUpgrade(Substrate.NetApiExt.Generated.Model.primitive_types.H256 code_hash, Substrate.NetApi.Model.Types.Primitive.Bool check_version)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
