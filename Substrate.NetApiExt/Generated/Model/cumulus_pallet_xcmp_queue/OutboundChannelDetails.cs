...
namespace Substrate.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue
{
    ...
    public sealed class OutboundChannelDetails : BaseType
    {
        ...
        /// >> recipient
        /// </summary>
        public Substrate.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id Recipient { get; set; }
        /// <summary>
        /// >> state
        /// </summary>
        public Substrate.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState State { get; set; }
        /// <summary>
        /// >> signals_exist
        /// </summary>
        ...
        {
            var start = p;
            Recipient = new Substrate.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id();
            Recipient.Decode(byteArray, ref p);
            State = new Substrate.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState();
